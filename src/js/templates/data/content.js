...
export const TEMPLATES = [
  ...
  },
  {
    ...
    desc: 'PICU bedside card set — arousal gate, CAPD, ps/pCAM-ICU, action cards, and attention picture cards. Print landscape, laminate, ring-bind.',
    orientation: 'landscape',
    pages: 9,
  ...
  },
  {
    ...
    desc: 'Emergency-department bedside cards, two to a landscape page — the DTS (arousal + LUNCH) beside the bCAM rule-in, then the 4AT beside the act-on-a-positive card. Laminate & ring-bind.',
    orientation: 'landscape',
    pages: 2,
  ...
  {
    id: 'stepdown-cards',
    name: 'Step-Down Delirium Card Set',
    desc: 'Adult step-down / progressive-care bedside cards, two to a landscape page — RASS beside the CAM-IMC additive screen, the admission-risk worksheet beside the prevention bundle, then act-on-a-positive. Laminate & ring-bind.',
    orientation: 'landscape',
    pages: 3,
    defaultTitle: 'Step-Down Delirium Card Set',
    defaultSubtitle: 'Screening, risk & prevention cards for step-down adults',
  },
  {
    id: 'stepdown-workflow',
    name: 'Step-Down Delirium Workflow',
    desc: 'Unit workflow poster — screen → gate → score → risk → act, with the hand-off script. Print landscape for the nurses’ station.',
    orientation: 'landscape',
    pages: 1,
    defaultTitle: 'Step-Down Delirium Workflow',
    defaultSubtitle: 'Screen · gate · score · risk · act',
  },
];
...
export const SECTIONS = {
  ...
  'peds-cards': [
    ...
    { id: 'sec-pc-capd', label: 'CAPD card', page: 2 },
    { id: 'sec-pc-pscam', label: 'psCAM-ICU card', page: 3 },
    { id: 'sec-pc-pcam', label: 'pCAM-ICU card', page: 4 },
    { id: 'sec-pc-act', label: 'Act-on-a-positive card', page: 5 },
    { id: 'sec-pc-prevent', label: 'Prevention bundle card', page: 6 },
    { id: 'sec-pc-stim', label: 'Attention picture cards', page: 7 },
  ],
  'peds-workflow': [{ id: 'sec-wf-poster', label: 'Workflow poster', page: 1 }],
  'ed-cards': [
    { id: 'sec-ed-dts', label: 'Step 1 · DTS card (arousal + LUNCH)', page: 1 },
    { id: 'sec-ed-bcam', label: 'bCAM card (confirmatory rule-in)', page: 1 },
    { id: 'sec-ed-4at', label: '4AT card (single-step alternative)', page: 2 },
    { id: 'sec-ed-act', label: 'Act-on-a-positive card', page: 2 },
  ],
  'ed-workflow': [{ id: 'sec-ed-wf-poster', label: 'Workflow poster', page: 1 }],
  'stepdown-cards': [
    { id: 'sec-sd-arousal', label: 'Arousal card (RASS + gate)', page: 1 },
    { id: 'sec-sd-camimc', label: 'CAM-IMC scoring card', page: 1 },
    { id: 'sec-sd-risk', label: 'Admission-risk worksheet', page: 2 },
    { id: 'sec-sd-prevent', label: 'Prevention bundle card', page: 2 },
    { id: 'sec-sd-act', label: 'Act-on-a-positive card', page: 3 },
  ],
  'stepdown-workflow': [{ id: 'sec-sd-wf-poster', label: 'Workflow poster', page: 1 }],
};
