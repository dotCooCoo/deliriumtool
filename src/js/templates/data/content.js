...
export const TEMPLATES = [
  ...
  },
  {
    ...
    desc: 'Emergency-department bedside card set — RASS gate, DTS → bCAM flowsheets, the 4AT, and an act-on-a-positive card. Print landscape, laminate, ring-bind.',
    orientation: 'landscape',
    pages: 5,
...
export const SECTIONS = {
  ...
  'ed-cards': [
    { id: 'sec-ed-arousal', label: 'Arousal card (RASS gate)', page: 1 },
    { id: 'sec-ed-dts', label: 'DTS card (triage rule-out)', page: 2 },
